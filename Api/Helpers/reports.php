...
class Report extends FPDF
{
    ...
    */
    ...
    {   
        //Imagen de fondo del reporte.
        $this->image('../../images/report_img.jpeg', 0, 0, 215);
        // Se ubica el título.
        $this->cell(20);
        $this->setFont('Arial', 'B', 15);
        $this->cell(166, 10, utf8_decode($this->title), 0, 1, 'C');
        //Se ubica el nombre de usuario
        $this->cell(20);
        $this->setFont('Arial', '', 10);
        $this->cell(166, 10, 'Usuario: '.$_SESSION['alias_usuario'], 0, 1, 'C');
